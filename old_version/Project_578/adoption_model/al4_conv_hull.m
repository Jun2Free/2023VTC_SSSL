...
while index_end < matSize
    ...
    A = [2*(l_DR(ref,1) - l_DR(index_2,1)) 2*(l_DR(ref,2) - l_DR(index_2,2)) 2*(l_DR(ref,3) - l_DR(index_2,3));
        2*(l_DR(ref,1) - l_DR(index_3,1)) 2*(l_DR(ref,2) - l_DR(index_3,2)) 2*(l_DR(ref,3) - l_DR(index_3,3));
        2*(l_DR(ref,1) - l_DR(index_4,1)) 2*(l_DR(ref,2) - l_DR(index_4,2)) 2*(l_DR(ref,3) - l_DR(index_4,3));
        2*(l_DR(ref,1) - l_DR(index_5,1)) 2*(l_DR(ref,2) - l_DR(index_5,2)) 2*(l_DR(ref,3) - l_DR(index_5,3));];
    B = [l_DR(ref,1)^2 - l_DR(index_2,1)^2 + l_DR(ref,2)^2 - l_DR(index_2,2)^2 + l_DR(ref,3)^2 - l_DR(index_2,3)^2 - d(ref)^2 + d(index_2)^2;
        l_DR(ref,1)^2 - l_DR(index_3,1)^2 + l_DR(ref,2)^2 - l_DR(index_3,2)^2 + l_DR(ref,3)^2 - l_DR(index_3,3)^2 - d(ref)^2 + d(index_3)^2;
        l_DR(ref,1)^2 - l_DR(index_4,1)^2 + l_DR(ref,2)^2 - l_DR(index_4,2)^2 + l_DR(ref,3)^2 - l_DR(index_4,3)^2 - d(ref)^2 + d(index_4)^2;
        l_DR(ref,1)^2 - l_DR(index_5,1)^2 + l_DR(ref,2)^2 - l_DR(index_5,2)^2 + l_DR(ref,3)^2 - l_DR(index_5,3)^2 - d(ref)^2 + d(index_5)^2;];
