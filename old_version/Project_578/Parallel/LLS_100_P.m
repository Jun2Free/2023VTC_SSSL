    ...
    while dr_move < 441         % for boundary trajectory
        ...
        if size(l_DR,1) == 1        % for the first loop, get two locations of drone
            while rt_cnt < 4
                ...
                elseif (dr_move >= 420) && (dr_move < 421) %100
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 400) && (dr_move < 420)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 399) && (dr_move < 400) %95
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 379) && (dr_move < 399)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 378) && (dr_move < 379) %90
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 358) && (dr_move < 378)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 357) && (dr_move < 358) %85
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 337) && (dr_move < 357)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 336) && (dr_move < 337) %80
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 316) && (dr_move < 336)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 315) && (dr_move < 316) %75
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 295) && (dr_move < 315)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 294) && (dr_move < 295) %70
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 274) && (dr_move < 294)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 273) && (dr_move < 274) %65
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 253) && (dr_move < 273)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 252) && (dr_move < 253) %60
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 232) && (dr_move < 252) %55
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 231) && (dr_move < 232) %55
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 211) && (dr_move < 231)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 210) && (dr_move < 211) %50
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 190) && (dr_move < 210)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 189) && (dr_move < 190) %45
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 169) && (dr_move < 189)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 168) && (dr_move < 169) %40
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 148) && (dr_move < 168)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 147) && (dr_move < 148) %35
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 127) && (dr_move < 147)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 126) && (dr_move < 127) % 30
                    l_x = l_x - 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 106) && (dr_move < 126)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 105) && (dr_move < 106) % 25
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 85) && (dr_move < 105)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 84) && (dr_move < 85)
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 64) && (dr_move < 84)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 63) && (dr_move < 64)
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 43) && (dr_move < 63)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 42) && (dr_move < 43)
                    l_x = l_x + 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 22) && (dr_move < 42)
                    l_x = l_x - 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move >= 21) && (dr_move < 22)
                    l_x = l_x - 0;
                    l_y = l_y + 5;
                    l_DR = [l_DR; l_x l_y l_z];
                elseif (dr_move > 0) && (dr_move < 21)
                    l_x = l_x + 5;
                    l_y = l_y + 0;
                    l_DR = [l_DR; l_x l_y l_z];
                end
...
plot3(l_DR(:,1), l_DR(:,2), l_DR(:,3), 'k-o'); hold on;  % Drone Trajectory
